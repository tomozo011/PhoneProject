...
<head>
    ...
    <title>比較Phone</title>
    <link rel="stylesheet" href="/css/docomo.css" media="screen">
        ...
        <body>
            <div class="carrier">
                <form action="/HikakuPhone/Docomo" method="post">
                    ...
                    <button type="submit" id="first">ドコモ</button>
                </form>
                ...
                <div class="wrapper">
                    ...
                    <div class="attention">
                        ...
                        <a href="https://www.docomo.ne.jp/charge/simulation/gigaho_gigalite/?dynaviid=case0001.dynavi" target="_blank">ドコモ公式シミュレーション</a>
                    </div>
                </div>
